...
public class RSSReaderTNEWS extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderTNEWS.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderTNEWS.this.retrieveRSSFeed("http://www.houstontexans.com/cda-web/rss-module.htm?tagName=News", RSSReaderTNEWS.this.itemlist);
            RSSReaderTNEWS.this.rssadaptor = new RSSListAdaptor(RSSReaderTNEWS.this, C0041R.layout.rssitemview, RSSReaderTNEWS.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderTNEWS.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderTNEWS.this.setListAdapter(RSSReaderTNEWS.this.rssadaptor);
