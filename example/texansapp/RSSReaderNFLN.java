...
public class RSSReaderNFLN extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderNFLN.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderNFLN.this.retrieveRSSFeed("http://www.nfl.com/rss/rsslanding?searchString=team&abbr=HOU", RSSReaderNFLN.this.itemlist);
            RSSReaderNFLN.this.rssadaptor = new RSSListAdaptor(RSSReaderNFLN.this, C0041R.layout.rssitemview, RSSReaderNFLN.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderNFLN.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderNFLN.this.setListAdapter(RSSReaderNFLN.this.rssadaptor);
    ...
    private void retrieveRSSFeed(String urlToRssFeed, ArrayList<RSSItem> list) {
        try {
            ...
            xmlreader.setContentHandler(new RSSParser1(list));
