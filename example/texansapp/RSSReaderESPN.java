...
public class RSSReaderESPN extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderESPN.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderESPN.this.retrieveRSSFeed("http://search.espn.go.com/rss/texans/videos/6", RSSReaderESPN.this.itemlist);
            RSSReaderESPN.this.rssadaptor = new RSSListAdaptor(RSSReaderESPN.this, C0041R.layout.rssitemview, RSSReaderESPN.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderESPN.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderESPN.this.setListAdapter(RSSReaderESPN.this.rssadaptor);
