...
public class RSSReaderNFLVIDEO extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderNFLVIDEO.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderNFLVIDEO.this.retrieveRSSFeed("http://www.nfl.com/rss/rsslanding?searchString=teamVideo&abbr=HOU", RSSReaderNFLVIDEO.this.itemlist);
            RSSReaderNFLVIDEO.this.rssadaptor = new RSSListAdaptor(RSSReaderNFLVIDEO.this, C0041R.layout.rssitemview, RSSReaderNFLVIDEO.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderNFLVIDEO.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderNFLVIDEO.this.setListAdapter(RSSReaderNFLVIDEO.this.rssadaptor);
    ...
    private void retrieveRSSFeed(String urlToRssFeed, ArrayList<RSSItem> list) {
        try {
            ...
            xmlreader.setContentHandler(new RSSParserNFL(list));
