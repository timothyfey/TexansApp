...
public class RSSReaderTVideo extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderTVideo.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderTVideo.this.retrieveRSSFeed("http://www.houstontexans.com/cda-web/rss-module.htm?tagName=Videos", RSSReaderTVideo.this.itemlist);
            RSSReaderTVideo.this.rssadaptor = new RSSListAdaptor(RSSReaderTVideo.this, C0041R.layout.rssitemview, RSSReaderTVideo.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderTVideo.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderTVideo.this.setListAdapter(RSSReaderTVideo.this.rssadaptor);
