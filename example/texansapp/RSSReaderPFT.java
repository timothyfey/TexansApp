...
public class RSSReaderPFT extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderPFT.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderPFT.this.retrieveRSSFeed("http://profootballtalk.nbcsports.com/category/teams/afc/houston-texans/feed/", RSSReaderPFT.this.itemlist);
            RSSReaderPFT.this.rssadaptor = new RSSListAdaptor(RSSReaderPFT.this, C0041R.layout.rssitemview, RSSReaderPFT.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderPFT.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderPFT.this.setListAdapter(RSSReaderPFT.this.rssadaptor);
