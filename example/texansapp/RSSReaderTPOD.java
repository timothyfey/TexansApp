...
public class RSSReaderTPOD extends ListActivity {
    ...
    private class RSSListAdaptor extends ArrayAdapter<RSSItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = ((LayoutInflater) RSSReaderTPOD.this.getSystemService("layout_inflater")).inflate(C0041R.layout.rssitemview, null);
            }
    ...
    private class RetrieveRSSFeeds extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            RSSReaderTPOD.this.retrieveRSSFeed("http://old.houstontexans.com/podcasts/miscellaneous.xml", RSSReaderTPOD.this.itemlist);
            RSSReaderTPOD.this.rssadaptor = new RSSListAdaptor(RSSReaderTPOD.this, C0041R.layout.rssitemview, RSSReaderTPOD.this.itemlist);
            return null;
        }
        ...
        protected void onPreExecute() {
            this.progress = ProgressDialog.show(RSSReaderTPOD.this, null, "Loading RSS Feeds...");
            super.onPreExecute();
        }

        protected void onPostExecute(Void result) {
            RSSReaderTPOD.this.setListAdapter(RSSReaderTPOD.this.rssadaptor);
